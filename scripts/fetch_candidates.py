...
for id in dic:
    if dic[id].fasta != '':
        m = '>'+id + '\n' + dic[id].fasta + '\n'
        l += m
        open('../data/fasta/'+id+'.fasta', 'w').write(m)
        os.system('/home/gurdeep/Downloads/signalp-4.1/signalp_TM -f long -s best ../data/fasta/'+id+'.fasta > ../data/signalp/'+id+'_long_TM.out')
        os.system('/home/gurdeep/Downloads/signalp-4.1/signalp_noTM -f long -s best ../data/fasta/'+id+'.fasta > ../data/signalp/'+id+'_long_noTM.out')
